  ...
  @endif
        ...
        <div class="form-head d-flex mb-sm-4 mb-3">
          ...
          <div>
            ...
            <a href="/gestion/nuevo-empleado" class="btn btn-success mr-3">+Nuevo Banco</a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="/gestion/nomina/crear-banco" method="post">
                  <div class="form-group">
                    <label class="text-black" style="font-size: 16px;">Banco</label>
                    <input type="text" name="val-banco" class="form-control">
                  </div>
                  <div class="form-group">
